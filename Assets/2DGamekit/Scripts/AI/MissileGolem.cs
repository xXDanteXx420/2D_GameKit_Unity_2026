...
#endif
{
    ...
    void Start()
    {
        audioBossManager = FindObjectOfType<AudioBossManager>();
    }
    ...
    void ActivateShield()
    {
        audioBossManager.BossShield(gameObject, 1);
    ...
    void FireLaser()
    {
        audioBossManager.BossLaserAttack(gameObject);
    ...
    void ActivateLightning()
    {
        ...
        audioBossManager.BossLightningAttack(lightning);
    ...
    void Cleanup()
    {
        ...
        */
        audioBossManager.BossDie(gameObject);
    ...
    void NextRound()
    {
        ...
        if (round == 2)
        {
            ...
            roundDeathSource.Play();
            */
            audioBossManager.BossSteamStage(gameObject, 1);
        }
        else if (round == 3)
        {
            ...
            roundDeathSource.Play();
            */
            audioBossManager.BossSteamStage(gameObject, 2);
        }
    }
    ...
    {
        audioBossManager.BossTakeDamage(gameObject);
    ...
    {
        audioBossManager.BossShield(gameObject, 0);
    ...
    {
        audioBossManager.BossWalk(gameObject);
    }
